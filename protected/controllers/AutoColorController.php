...
class AutoColorController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['AutoColor'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('AutoColor');
	...
	{
		$model=new AutoColor('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AutoColor']))
			$model->attributes=$_GET['AutoColor'];
